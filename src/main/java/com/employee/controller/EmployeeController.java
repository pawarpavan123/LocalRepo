...
@GetMapping("/{id}")
    public ResponseEntity<EmployeeDto> getSingleEmployee(@PathVariable ("id") Long id){
...
@GetMapping("/by-emp-code-and-company-name")
public ResponseEntity<EmployeeDto> getEmployeeByEmpCodeAndCompanyName(@RequestParam (value = "empCode", required = false) String empCode,
    ...
    if (!missingParameters.isEmpty())
    {
        ...
        throw new MissingParameterException("Missing parameters: " + finalMessage);
    }
